...
//        View.inflate(context, R.layout.uxsdk_liveview_pfd_speed_display_widget, this)
    ...
    override fun reactToModelChanges() {
        ...
        addDisposable(widgetModel.attitudeYawProcessor.toFlowable().observeOn(SchedulerProvider.ui()).subscribe {
    ...
    private fun getAircraftDegree(): Float {
        return widgetModel.attitudeYawProcessor.value.toFloat() + if (widgetModel.attitudeYawProcessor.value.toFloat() < 0) 359F else 0F
    }
